...
function createApp() {
    const app = express();
    // app.use(cors({
    //     origin: 'http://localhost:5000/api/api-docs', // Replace with your actual allowed origin
    // }));
    ...
    function generateSchemas() {
        ...
        const models = [
            { model: UserModel, schemaName: 'User' },
    ...
    const swaggerOptions = {
        ...
        security: [
            {
                JWT: [], // Empty array means authentication is required
            },
        ],
        // basePath: '/',
    };
